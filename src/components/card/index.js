        ...
        <>
          {context.characterlike.indexOf(id) !== -1 ? (
            ...
            <li key={id} onClick={() => handlecharacter(id)}>
              <div
                className={` relative py-2 px-2 border-y border-slate-100 ${
                  idp === id ? "bg-primary-100" : " bg-white"
                }  hover:bg-primary-100  hover:rounded-xl space-y-2
              ...
              >
                ...
                <div className="text-center flex space-y-2 space-x-2 sm:text-left pr-1.5">
                  <div className="space-y-0.5 w-[215px]">
                    ...
                    <p className="text-slate-500 font-small"> {species}</p>
                  </div>
