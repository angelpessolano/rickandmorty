...
const Filter_A = () => {
  ...
  return (
    <div className="relative shadow bg-white w-auto h-278 top-[-120px] sm:top-0 p-4 rounded-6  ">
      <div
          ...
          {characterOptions.map((option) => (
            <li key={option.value}>
              <input
                ...
                value={option.value}
                disabled={
                  option.value === "Starred" && context.count === 0
                    ? true
                    : false
                }
              ...
              <label
                ...
                className={`inline-flex items-center justify-between p-2 text-primary-700 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:bg-primary-100 peer-checked:border-primary-700  peer-checked:text-primary-700 hover:text-gray-600 hover:bg-primary-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 ${
                  option.value === "Starred" && context.count == 0
